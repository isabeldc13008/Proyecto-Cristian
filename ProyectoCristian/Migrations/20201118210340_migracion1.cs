    ...
    public partial class migracion1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_productos = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ...
                    estado = table.Column<int>(nullable: false),
                    categoriasid_categoria = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_productos_categorias_categoriasid_categoria",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_productos_categoriasid_categoria",
                table: "productos",
